          ...
          <div className="relative overflow-x-auto">
            ...
            <div className="absolute left-0 top-0 w-16 md:w-20 h-full">
              {timeSlots.map((time, index) => (
                <div
                  key={index}
                  className="h-20 md:h-24 flex items-start justify-end pr-2 md:pr-4"
                >
            ...
            <div className="ml-16 md:ml-20 relative border-l border-gray-200 min-w-[600px] md:min-w-0">
              {timeSlots.map((_, index) => (
                <div
                  key={index}
                  className="h-20 md:h-24 border-b border-gray-200"
                />
              ))}
              ...
              {tasks.map((task) => (
                <div
                  ...
                  className={`${getTaskColor(
                    task.priority
                  )} absolute left-0 right-4 rounded-lg p-2 hover:shadow-md transition-all duration-200 cursor-pointer overflow-hidden`}
                  style={{
