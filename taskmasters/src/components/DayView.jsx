      ...
      <div className="flex h-screen w-full">
        ...
        <div className="flex-1 bg-gray-50 p-8 overflow-y-auto">
          ...
          <div className="flex mb-8">
            <button className="bg-[#9706e9] text-white px-4 py-2 rounded-l font-semibold">
              Day
            </button>
            <button className="bg-[#9706e9]/70 text-white px-4 py-2 border-l border-r border-purple-800 hover:bg-[#9706e9]">
              Week
            </button>
            <button className="bg-[#9706e9]/70 text-white px-4 py-2 rounded-r hover:bg-[#9706e9]">
              Month
            </button>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute left-0 top-0 w-20 h-full">
              {timeSlots.map((time, index) => (
                <div
                  key={index}
                  className="h-24 flex items-start justify-end pr-4"
                >
              ...
              {tasks.map((task) => (
                <div
                  ...
                  className={`${getTaskColor(
                    task.priority
                  )} absolute left-0 right-4 rounded-lg p-4 flex flex-col hover:shadow-md transition-all duration-200 cursor-pointer`}
                  style={{
